...
st.write(
    "Non ci sono dati nulli. Quindi non ho bisogno di ripulire i dati. Vediamo la percentuale di laureati per diversi atenei di Milano nel 2013 tramite i seguenti grafici:"
)
...
sns.barplot(x="Sesso", y="LAUREATI_TOTALE", data=df)
...
st.write(
    "Le donne laureate sono in numero differente, maggiore o minore rispetto agli uomini nel 2021, a seconda dei vari ateni milanesi."
)
